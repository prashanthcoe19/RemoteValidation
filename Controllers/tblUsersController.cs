...
using remoteValidation2.Models;

namespace remoteValidation2.Controllers
{
    public class tblUsersController : Controller
    {
        ...
        public JsonResult IsUserNameAvailable(string UserName)
        {
            try
            {
                return Json(!db.tblUsers.Any(User => User.UserName == UserName), JsonRequestBehavior.AllowGet);
            }
            catch (Exception)
            {
